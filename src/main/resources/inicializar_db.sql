...
create table Usuario(id int auto_increment primary key not null, correo varchar (100) not null, contraseña varchar(100) not null, rol varchar (20) not null);
insert into Usuario (correo, contraseña,rol) values ('admin@hospital.com','1234','admin');
insert into Usuario (correo, contraseña, rol) values ('medico@hospital.com', 'medico123', 'medico');
insert into Usuario (correo, contraseña, rol) values ('paciente@test.com', 'paciente123', 'paciente');
